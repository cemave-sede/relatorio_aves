...
```{r 61, echo = FALSE, out.width = '90%', fig.pos = 'H', fig.align="center", fig.cap = '(ref:leg1)'}
...
```{r 62, echo = FALSE, out.width = '55%', fig.pos = 'H', fig.align="center", fig.cap = 'Localização das usinas eólicas instaladas ou em instalação no Brasil. Fonte: ANEEL (2021b)'}
...
```{r 63, echo = FALSE, out.width = '65%', fig.pos = 'H', fig.align="center", fig.cap = 'Usinas eólicas no Brasil: potência outorgada por estado da federação, em operação ou em fase de construção. Fonte: ANEEL (2021a)'}
...
```{r 65, echo = FALSE, out.width = '75%', fig.pos = 'H', fig.align="center", fig.cap='(ref:long9)'}
...
```{r 66, echo = FALSE, out.width = '65%', fig.pos = 'H', fig.align="center", fig.cap='(ref:long10)'}
...
kbl(tabela_8.1,
             ...
             align = "llccccll",
             caption = "(ref:tabela8)",
             col.names = c("Táxon", "Nome comum", "Status global", "Status nacional", "Área de ocorrência predominante", "Habitat", "Status migratório", "Impacto potencial / Risco presumido")) %>%
...
kable_styling(full_width = F, bootstrap_options = c("striped", "hover", "condensed", "responsive"), font_size = 14, latex_options = c("repeat_header"), repeat_header_text = "\\textit{(continuação)}") %>%
            footnote(number = c("Sequências e nomenclaturas estão de acordo com a lista brasileira de aves (Pacheco et al. 2021).", "Status global de conservação segue classificação da IUCN (2020) e o nacional segue MMA (2014).", "As espécies vagantes foram excluídas, pois têm baixa probabilidade de impacto oriundo dos CEOs e baixo risco presumível."), threeparttable=T)
