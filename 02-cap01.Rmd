...
```{r 01, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", out.width = '60%', fig.cap = 'Composição da matriz elétrica do Brasil em 2020. Fonte: MME (2020a)'}
...
```{r 02, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", out.width = '70%', fig.cap = 'Distribuição do potencial eólico das regiões do país. Fonte: Amarante et al. (2001)'}
...
```{r 03, cache=TRUE, echo=FALSE, fig.align="center", fig.pos = 'H', fig.cap='Evolução da geração de energia eólica no Brasil de 2005 a 2020. Fonte: ABEEólica (2021)', message=FALSE, warning=FALSE, out.width='80%'}
...
```{r 05, cache=TRUE, echo=FALSE, fig.align="center", fig.pos = 'H', out.width = '80%', fig.cap = 'Distribuição da potência instalada de geração de energia eólica por estado. Rio Grande do Norte e Bahia se destacam, com potência instalada na faixa dos 5000 MW. Fonte: ABEEólica (2021)'}
...
```{r 06, cache=TRUE, echo=FALSE, fig.align="center", fig.pos = 'H', out.width = '80%', fig.cap = 'Número de parques eólicos instalados por estado. Rio Grande do Norte e Bahia se destacam, com valores superiores a 150 parques. Fonte: ABEEólica (2021)'}

knitr::include_graphics("imagens/cap01/Figura_1.6_1.jpg")

# P3 <-  ggplot(data = cres_estados, aes(x= fct_reorder(UF, parques, .desc = T), y = parques, label = parques)) +
#  geom_bar(stat = "identity", fill="#1F95C5") +
#  #coord_flip() +
#     geom_text(aes(label = parques), vjust = -0.5) +
#     theme(
#     panel.background = element_blank(),
#     panel.grid.minor.y = element_blank(),
#     panel.grid.major.y = element_blank(),
...
```{r 07, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', out.width = '70%', fig.align="center", fig.cap = 'Países com maior capacidade de geração de energia eólica. Os valores indicam o potencial instalado em MW. Fonte: GWEC (2021)'}
...
```{r 08, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', out.width = '60%', fig.align="center", fig.cap = 'Previsão da composição da matriz elétrica do Brasil em 2030. Fonte: MME (2020a)'}
...
Além da Energia. 2021. Conheça os 20 projetos de energia eólica offshore em andamento no Brasil. Disponível em: https://www.alemdaenergia.com.br/conheca-as-fases-dos-20-projetos-de-energia-eolica-offshore-em-andamento-no-brasil/ Acesso em: [08/09/2021].  
...
Canal Energia. 2021. Energia eólica chega a 18 GW de capacidade instalada no Brasil. Disponível em: https://canalenergia.com.br/?noticia=energia-eolica-chega-a-18-gw-de-capacidade-instalada-no-brasil Acesso em: [07/05/2021].  
...
Marinho PH et al. 2021. O vento levará nossa biodiversidade? Disponível em: https://www.oeco.org.br/analises/o-vento-levara-nossa-biodiversidade/ Acesso em: [08/09/2021].  
