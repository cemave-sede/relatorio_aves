...
```{r 02, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.pos = 'H', fig.align="center", out.width = '55%', fig.cap = 'Distribuição do potencial eólico das regiões do país. Fonte: Amarante et al. (2001).'}
...
```{r 03, cache=TRUE, echo=FALSE, fig.pos = 'H', fig.align="center", fig.cap='Evolução da geração de energia eólica no Brasil de 2005 a 2020. Fonte: ABEEólica (2020)', message=FALSE, warning=FALSE, out.width='70%'}
...
```{r 05, cache=TRUE, echo=FALSE, fig.pos = 'H', fig.align="center", out.width = '65%', fig.cap = 'Distribuição da potência instalada de geração de energia eólica por estado. Rio Grande do Norte e Bahia se destacam, com potência instalada na faixa dos 5000 MW. Fonte: ABEEólica (2020)'}
...
```{r 06, cache=TRUE, echo=FALSE, fig.pos = 'H', fig.align="center", out.width = '65%', fig.cap = 'Número de parques eólicos instalados por estado. Bahia e Rio Grande do Norte se destacam, com valores superiores a 150 parques. Fonte: ABEEólica (2020)'}
...
```{r 07, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, out.width = '60%', fig.pos = 'H', fig.align="center", fig.cap = 'Em 2019 o Brasil assumiu a 7ª posição no ranking dos países com maior capacidade de geração de energia eólica. Os valores indicam o potencial instalado em MW. Fonte: GWEC (2021).'}
...
```{r 08, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, out.width = '55%', fig.pos = 'H', fig.align="center", fig.cap = 'Previsão da composição da matriz elétrica do Brasil em 2030. Fonte: MME (2020a)'}
