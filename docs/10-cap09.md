...
<img src="imagens/cap09/Figura_9.1.png" alt="Riqueza potencial de espécies de morcegos modelada para o Brasil." width="75%" />
...
<caption>(\#tab:tab09)Distribuição de aerogeradores por bioma no Brasil. Dados da ANEEL para janeiro de 2022.</caption>
 <thead>
  <tr>
