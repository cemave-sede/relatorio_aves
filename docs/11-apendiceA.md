...
<sup>1</sup> Nomenclatura de acordo com o Comitê Brasileiro de Registros Ornitológicos - CBRO (Pacheco et al. 2021).</td></tr>
<tr><td style="padding: 0; " colspan="100%">
<sup>2</sup> A = Reprodução exclusiva no Brasil; B = Flocking; C = Voo noturno ou crepuscular; D =	Planador; E = Alta sensibilidade aos impactos das estruturas de apoio, exceto colisão; F = Massa corporal média (0,25 qdo &gt;300g); G =	categoria de ameaça; H = PESO FINAL</td></tr>
</tfoot>
</table>
