...
<div class="figure">
<img src="imagens/cap07/Figura_7.1.jpg" alt="Máximas, médias e mínimas das proporções totais de células por espécie de ave migratória conforme percentual de células totais remanescentes durante a priorização pelo Zonation e destaque do limiar de corte em 7%." width="85%" />
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.5.jpg" alt="Colônia reprodutiva de Thalasseus acuflavidus na Ilha Escalvada, ES. Foto César Musso" width="40%" />
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.6.jpg" alt="Concentração de Rostrhamus sociabilis (gavião-caramujeiro) na Chapada dos Guimarães. Foto: Mauricio Santos" width="75%" />
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.7.jpg" alt="Bando do migratório neártico maçarico-de-papo-vermelho (Calidris canutus) na margem oeste da lagoa Mirim. Foto: Aurélea Mader" width="75%" />
<p class="caption">(\#fig:27)Bando do migratório neártico maçarico-de-papo-vermelho (Calidris canutus) na margem oeste da lagoa Mirim. Foto: Aurélea Mader</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.8.jpg" alt="Bando de maçarico-de-papo-vermelho (Calidris canutus) no Balneário Rincão, SC. Foto: Rafael Romagna" width="75%" />
<p class="caption">(\#fig:28)Bando de maçarico-de-papo-vermelho (Calidris canutus) no Balneário Rincão, SC. Foto: Rafael Romagna</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.9.jpg" alt="Colônia de Onychoprion fuscatus. Foto: Patrícia Serafini" width="75%" />
<p class="caption">(\#fig:29)Colônia de Onychoprion fuscatus. Foto: Patrícia Serafini</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.10.png" alt="Áreas de Concentração para Aves Migratórias no Brasil." width="75%" />
<p class="caption">(\#fig:30)Áreas de Concentração para Aves Migratórias no Brasil.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.11_AL.png" alt="Áreas de Concentração para Aves Migratórias no estado de Alagoas." width="75%" />
<p class="caption">(\#fig:31)Áreas de Concentração para Aves Migratórias no estado de Alagoas.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.12_BA.png" alt="Áreas de Concentração para Aves Migratórias no estado da Bahia." width="75%" />
<p class="caption">(\#fig:32)Áreas de Concentração para Aves Migratórias no estado da Bahia.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.13_CE.png" alt="Áreas de Concentração para Aves Migratórias no estado do Ceará." width="75%" />
<p class="caption">(\#fig:33)Áreas de Concentração para Aves Migratórias no estado do Ceará.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.14_MA.png" alt="Áreas de Concentração para Aves Migratórias no estado do Maranhão." width="75%" />
<p class="caption">(\#fig:34)Áreas de Concentração para Aves Migratórias no estado do Maranhão.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.15_PB.png" alt="Áreas de Concentração para Aves Migratórias no estado da Paraíba." width="75%" />
<p class="caption">(\#fig:35)Áreas de Concentração para Aves Migratórias no estado da Paraíba.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.16_PE.png" alt="Áreas de Concentração para Aves Migratórias no estado de Pernambuco." width="75%" />
<p class="caption">(\#fig:36)Áreas de Concentração para Aves Migratórias no estado de Pernambuco.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.17_PI.png" alt="Áreas de Concentração para Aves Migratórias no estado do Piauí." width="75%" />
<p class="caption">(\#fig:37)Áreas de Concentração para Aves Migratórias no estado do Piauí.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.18_RN.png" alt="Áreas de Concentração para Aves Migratórias no estado do Rio Grande do Norte." width="75%" />
<p class="caption">(\#fig:38)Áreas de Concentração para Aves Migratórias no estado do Rio Grande do Norte.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.19_SE.png" alt="Áreas de Concentração para Aves Migratórias no estado de Sergipe." width="75%" />
<p class="caption">(\#fig:39)Áreas de Concentração para Aves Migratórias no estado de Sergipe.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.20_AC.png" alt="Áreas de Concentração para Aves Migratórias no estado do Acre." width="75%" />
<p class="caption">(\#fig:40)Áreas de Concentração para Aves Migratórias no estado do Acre.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.21_AP.png" alt="Áreas de Concentração para Aves Migratórias no estado do Amapá." width="75%" />
<p class="caption">(\#fig:41)Áreas de Concentração para Aves Migratórias no estado do Amapá.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.22_AM.png" alt="Áreas de Concentração para Aves Migratórias no estado do Amazonas." width="75%" />
<p class="caption">(\#fig:42)Áreas de Concentração para Aves Migratórias no estado do Amazonas.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.23_PA.png" alt="Áreas de Concentração para Aves Migratórias no estado do Pará." width="75%" />
<p class="caption">(\#fig:43)Áreas de Concentração para Aves Migratórias no estado do Pará.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.24_RO.png" alt="Áreas de Concentração para Aves Migratórias no estado de Rondônia." width="75%" />
<p class="caption">(\#fig:44)Áreas de Concentração para Aves Migratórias no estado de Rondônia.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.25_RR.png" alt="Áreas de Concentração para Aves Migratórias no estado de Roraima." width="75%" />
<p class="caption">(\#fig:45)Áreas de Concentração para Aves Migratórias no estado de Roraima.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.26_TO.png" alt="Áreas de Concentração para Aves Migratórias no estado do Tocantins." width="75%" />
<p class="caption">(\#fig:46)Áreas de Concentração para Aves Migratórias no estado do Tocantins.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.27_ES.png" alt="Áreas de Concentração para Aves Migratórias no estado do Espírito Santo." width="75%" />
<p class="caption">(\#fig:47)Áreas de Concentração para Aves Migratórias no estado do Espírito Santo.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.28_MG.png" alt="Áreas de Concentração para Aves Migratórias no estado de Minas Gerais." width="75%" />
<p class="caption">(\#fig:48)Áreas de Concentração para Aves Migratórias no estado de Minas Gerais.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.29_RJ.png" alt="Áreas de Concentração para Aves Migratórias no estado do Rio de Janeiro." width="75%" />
<p class="caption">(\#fig:49)Áreas de Concentração para Aves Migratórias no estado do Rio de Janeiro.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.30_SP.png" alt="Áreas de Concentração para Aves Migratórias no estado de São Paulo." width="75%" />
<p class="caption">(\#fig:50)Áreas de Concentração para Aves Migratórias no estado de São Paulo.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.31_DF.png" alt="Áreas de Concentração para Aves Migratórias no Distrito Federal." width="75%" />
<p class="caption">(\#fig:51)Áreas de Concentração para Aves Migratórias no Distrito Federal.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.32_GO.png" alt="Áreas de Concentração para Aves Migratórias no estado de Goiás." width="75%" />
<p class="caption">(\#fig:52)Áreas de Concentração para Aves Migratórias no estado de Goiás.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.33_MT.png" alt="Áreas de Concentração para Aves Migratórias no estado de Mato Grosso." width="75%" />
<p class="caption">(\#fig:53)Áreas de Concentração para Aves Migratórias no estado de Mato Grosso.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.34_MS.png" alt="Áreas de Concentração para Aves Migratórias no estado de Mato Grosso do Sul." width="75%" />
<p class="caption">(\#fig:54)Áreas de Concentração para Aves Migratórias no estado de Mato Grosso do Sul.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.35_PR.png" alt="Áreas de Concentração para Aves Migratórias no estado do Paraná." width="75%" />
<p class="caption">(\#fig:55)Áreas de Concentração para Aves Migratórias no estado do Paraná.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.36_RS.png" alt="Áreas de Concentração para Aves Migratórias no estado do Rio Grande do Sul." width="75%" />
<p class="caption">(\#fig:56)Áreas de Concentração para Aves Migratórias no estado do Rio Grande do Sul.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.37_SC.png" alt="Áreas de Concentração para Aves Migratórias no estado de Santa Catarina." width="75%" />
<p class="caption">(\#fig:57)Áreas de Concentração para Aves Migratórias no estado de Santa Catarina.</p>
</div>

<br>
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.38_Abrolhos.png" alt="Áreas de Concentração para Aves Migratórias no arquipélago de Abrolhos." width="75%" />
<p class="caption">(\#fig:58)Áreas de Concentração para Aves Migratórias no arquipélago de Abrolhos.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.39_Rocas_Noronha.png" alt="Áreas de Concentração para Aves Migratórias no atol das Rocas e no arquipélago de Fernando de Noronha." width="75%" />
<p class="caption">(\#fig:59)Áreas de Concentração para Aves Migratórias no atol das Rocas e no arquipélago de Fernando de Noronha.</p>
</div>

<br>

<div class="figure" style="text-align: center">
<img src="imagens/cap07/Figura_7.40_Trindade_M_Vaz.png" alt="Áreas de Concentração para Aves Migratórias no arquipélago de Trindade e Martim-Vaz." width="75%" />
<p class="caption">(\#fig:60)Áreas de Concentração para Aves Migratórias no arquipélago de Trindade e Martim-Vaz.</p>
</div>
...
<caption>(\#tab:tab06)Número de aerogeradores por estado, áreas de varredura dos rotores e comparativo em projeção vertical.</caption>
 <thead>
  <tr>
   ...
   <th style="text-align:right;"> Soma da área de varredura das pás (m2) </th>
   <th style="text-align:right;"> Dimensão em projeção vertical, com 100 m de altura, da soma da área de varredura das pás (km) </th>
  </tr>
 </thead>
<tbody>
  <tr>
   ...
   <td style="text-align:right;width: 4cm; "> 92366748.66 </td>
   <td style="text-align:right;width: 4cm; "> 923.67 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> CE </td>
   <td style="text-align:right;"> 1705 </td>
   <td style="text-align:right;width: 4cm; "> 21389264.02 </td>
   <td style="text-align:right;width: 4cm; "> 213.89 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> MA </td>
   <td style="text-align:right;"> 193 </td>
   <td style="text-align:right;width: 4cm; "> 2229425.16 </td>
   <td style="text-align:right;width: 4cm; "> 22.29 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> MG </td>
   <td style="text-align:right;"> 320 </td>
   <td style="text-align:right;width: 4cm; "> 6247513.62 </td>
   <td style="text-align:right;width: 4cm; "> 62.48 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> PB </td>
   <td style="text-align:right;"> 1003 </td>
   <td style="text-align:right;width: 4cm; "> 16221772.19 </td>
   <td style="text-align:right;width: 4cm; "> 162.22 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> PE </td>
   <td style="text-align:right;"> 698 </td>
   <td style="text-align:right;width: 4cm; "> 8337202.50 </td>
   <td style="text-align:right;width: 4cm; "> 83.37 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> PI </td>
   <td style="text-align:right;"> 1641 </td>
   <td style="text-align:right;width: 4cm; "> 20960472.05 </td>
   <td style="text-align:right;width: 4cm; "> 209.60 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> PR </td>
   <td style="text-align:right;"> 34 </td>
   <td style="text-align:right;width: 4cm; "> 281965.69 </td>
   <td style="text-align:right;width: 4cm; "> 2.82 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> RJ </td>
   <td style="text-align:right;"> 12 </td>
   <td style="text-align:right;width: 4cm; "> 63370.34 </td>
   <td style="text-align:right;width: 4cm; "> 0.63 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> RN </td>
   <td style="text-align:right;"> 4693 </td>
   <td style="text-align:right;width: 4cm; "> 61088354.36 </td>
   <td style="text-align:right;width: 4cm; "> 610.88 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> RS </td>
   <td style="text-align:right;"> 1530 </td>
   <td style="text-align:right;width: 4cm; "> 16832971.43 </td>
   <td style="text-align:right;width: 4cm; "> 168.30 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> SC </td>
   <td style="text-align:right;"> 164 </td>
   <td style="text-align:right;width: 4cm; "> 713224.17 </td>
   <td style="text-align:right;width: 4cm; "> 7.13 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> SE </td>
   <td style="text-align:right;"> 23 </td>
   <td style="text-align:right;width: 4cm; "> 124140.64 </td>
   <td style="text-align:right;width: 4cm; "> 1.24 </td>
  </tr>
</tbody>
<tfoot><tr><td style="padding: 0; " colspan="100%">
<sup>1</sup> Os diâmetros das pás dos rotores dos aerogeradores são disponibilizados no sítio eletrônico da ANEEL. A partir desses valores foi calculada a área de varredura de cada aerogerador (Área=pr2). As áreas de varredura de todos os aerogeradores listados para cada estado foram somadas e apresentadas na tabela acima. Para fins de comparação, na última coluna a soma das áreas de varredura das pás é apresentada em projeção vertical, com 100 m de altura, simulando os círculos do giro das hélices, alinhados, justapostos, lado a lado, com seu comprimento total expresso em quilômetros.</td></tr></tfoot>
</table>
